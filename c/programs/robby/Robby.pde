...
void initScenes() {
  ...
  scenes[0].addAction("run", 1, 14, 62, 4, 2);
  ...
  scenes[4].addAction("burn the wire", 10, 1, 1, 2, 11);
  scenes[4].addAction("turn off the light", 7, 3, 7, 2, 15);
  ...
  scenes[6].addAction("do this", 3, 1, 30, 2, 14);
  scenes[6].addAction("do this", 3, 4, 30, 2, 18);
  scenes[6].addAction("do this", 3, 6, 30, 2, 19);
  scenes[6].addAction("do this", 3, 9, 30, 2, 13);
  scenes[6].addAction("do this", 3, 12, 30, 1, 20);
  scenes[7] = new Scene("night.txt", 7);
  scenes[7].addAction("turn on the light", 7, 3, 7, 2, 16);
  ...
  scenes[14].addAction("say this", 3, 1, 30, 1, 0);
  scenes[14].addAction("say this", 3, 3, 30, 3, 0);
  scenes[14].addAction("say this", 3, 7, 30, 2, 27);
  ...
  scenes[16].addAction("burn the wire", 17, 1, 13, 3, 36);
...
void countdownGoesOn() {
  countdown++;
  if (countdown>=100) {
    appendText("<br/>policeman : \"100... PAN !<br/>You die dead.");
    moveToScene(9);
    setTimeout(function() {
      $('#restart').show();
    }, 3000);
